...
import view.CaracteristicaProdutoForm;
 ...
 * @author Nasser
 */
public class CaracteristicaProdutoController implements ActionListener {

    public CaracteristicaProdutoController(CaracteristicaProdutoForm caracteristicaProdutoForm) {
